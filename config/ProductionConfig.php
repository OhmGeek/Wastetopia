...
class ProductionConfig extends AbstractConfig
{
    public function getConfiguration()
    {
        ...
        return array(
            ...
            'ROOT_JS' => '//wastetopia-pr-28.herokuapp.com/js',
            'ROOT_CSS' => '//wastetopia-pr-28.herokuapp.com/css',
            'ROOT_IMG' => '//wastetopia-pr-28.herokuapp.com/img',
            'ROOT_BASE' => '//wastetopia-pr-28.herokuapp.com'
        );
    }
}
